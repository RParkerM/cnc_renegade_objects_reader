...
// Ported from Code/Tools/LevelEdit/DummyObjectDefinition.cpp
[RegisterDefinition(ChunkId.CHUNKID_DUMMY_OBJECT_DEF)]
public partial class DummyObjectDefinitionClass : DefinitionClass
{
    public DummyObjectDefinitionClass()
    {
        // FILENAME_PARAM (m_ModelName, "Westwood 3D Files", ".w3d");
    }

    public override uint Get_Class_ID() => (uint)ClassId.CLASSID_DUMMY_OBJECTS;
    ...
    public override bool Load(ChunkLoadClass cload)
    {
        ...
        while (cload.Open_Chunk())
        {
            switch (cload.Cur_Chunk_ID)
            {
                ...
                default:
                    Console.WriteLine("Unrecognized DummyObjectDef chunkID\n");
                    break;
            }
