...
[RegisterDefinition(ChunkId.CHUNKID_GAME_OBJECT_DEF_COMCENTER)]
public partial class ComCenterGameObjDef : BuildingGameObjDef
{
    public ComCenterGameObjDef()
    {
    }

    public override uint Get_Class_ID() => ClassId.CLASSID_GAME_OBJECT_DEF_COMCENTER;
    ...
    public override bool Load(ChunkLoadClass cload)
    {
        while (cload.Open_Chunk())
        {
            switch (cload.Cur_Chunk_ID)
            {
                ...
                default:
                    Console.WriteLine("Unrecognized Com Center Def chunkID\n");
                    break;
            }
            cload.Close_Chunk();
        }
