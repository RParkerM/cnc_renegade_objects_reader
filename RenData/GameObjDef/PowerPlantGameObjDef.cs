...
[RegisterDefinition(ChunkId.CHUNKID_GAME_OBJECT_DEF_POWERPLANT)]
public partial class PowerPlantGameObjDef : BuildingGameObjDef
{
    public PowerPlantGameObjDef()
    {
    }

    public override uint Get_Class_ID() => ClassId.CLASSID_GAME_OBJECT_DEF_POWERPLANT;
    ...
    public override bool Load(ChunkLoadClass cload)
    {
        while (cload.Open_Chunk())
        {
            switch (cload.Cur_Chunk_ID)
            {
                ...
                default:
                    Console.WriteLine("Unrecognized Powerplant Def chunkID\n");
                    break;
            }
            cload.Close_Chunk();
        }
